...
class Airline(models.Model):
    ...
    code = models.CharField(max_length=10, unique=True, help_text="Mã IATA (VD: VN, VJ)")
...
class Aircraft(models.Model):
    ...
    registration_number = models.CharField(max_length=50, unique=True, help_text="Số đăng ký máy bay (VD: VN-A123)")
